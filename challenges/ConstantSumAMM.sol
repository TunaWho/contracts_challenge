...
https://www.youtube.com/watch?v=Luff_OGvYtI
*/
...
contract CSAMM {
    ...
    function addLiquidity(
        ...
        // Mint shares propotional to the increase in liquidity to msg.sender. Liquidity is the total amount of tokens in the contract. (reserve0 + reserve1).
    ...
    function removeLiquidity(uint _shares) external returns (uint d0, uint d1) {
        // Transfers token0 and token out to msg.sender.
